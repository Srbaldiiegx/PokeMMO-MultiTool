...
function openModal(profile) {
    ...
    if (pList.length === 0) {
        ...
        pList.forEach(pokemon => {
            ...
            const alphaIcon = pokemon.isAlpha ? '<img class="alpha-icon alpha-icon-card" src="css/alpha-icon.png" alt="Alfa" title="Shiny Alfa">' : '';
...
function openPokemonModal(pokemon) {
    ...
    if (pokemon.isAlpha) {
        ...
        alphaIcon.src = 'css/alpha-icon.png';
...
function renderShowcase(filter = '') {
    ...
    sorted.forEach(profile => {
        ...
        const buddyAlphaIcon = favorite?.isAlpha ? '<img class="alpha-icon alpha-icon-buddy" src="css/alpha-icon.png" alt="Alfa" title="Shiny Alfa">' : '';
